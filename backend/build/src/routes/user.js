...
// Create a new tour
userRoutes.post('/users/update-profile', (0, authorize_roles_1.authorizeRole)([user_profile_types_1.UserRole.ADMIN, user_profile_types_1.UserRole.AGENT, user_profile_types_1.UserRole.CUSTOMER]), index_1.updateUserProfile);
// Get all users with pagination
userRoutes.get('/users', (0, authorize_roles_1.authorizeRole)([user_profile_types_1.UserRole.ADMIN]), index_1.getAllUsers);
// Change user role
userRoutes.put('/users/:userId/role', (0, authorize_roles_1.authorizeRole)([user_profile_types_1.UserRole.ADMIN]), index_1.changeUserRole);
// Delete a user
